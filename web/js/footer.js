        ...
        <div class="max-w-[1200px] mx-auto px-6 py-12 flex flex-col justify-between h-full">
            ...
            <div class="flex flex-col items-center justify-center w-full mb-12">
                ...
                <div class="flex space-x-8">
                    <!-- YouTube -->
                    <a href="#" class="text-gray-400 hover:text-red-600 transition-colors transform hover:scale-110 duration-200" aria-label="YouTube">
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/></svg>
                    </a>
                    <!-- TikTok -->
                    <a href="#" class="text-gray-400 hover:text-pink-500 transition-colors transform hover:scale-110 duration-200" aria-label="TikTok">
                    ...
                    <!-- Instagram -->
                    <a href="#" class="text-gray-400 hover:text-corporate-orange transition-colors transform hover:scale-110 duration-200" aria-label="Instagram">
            ...
            <div class="text-xs text-gray-300 w-full text-center flex flex-col md:flex-row justify-center items-center gap-2 md:gap-4">
